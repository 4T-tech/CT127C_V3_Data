...
void MX_ADC_Init(void)
{
  ...
  */
  LL_ADC_REG_SetSequencerRanks(ADC, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_2);
   ...
   /* Clear flag ADC channel configuration ready */
   LL_ADC_ClearFlag_CCRDY(ADC);
  LL_ADC_SetChannelSamplingTime(ADC, LL_ADC_CHANNEL_2, LL_ADC_SAMPLINGTIME_COMMON_1);

  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC, LL_ADC_REG_RANK_2, LL_ADC_CHANNEL_3);
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC, LL_ADC_REG_RANK_3, LL_ADC_CHANNEL_11);
   ...
   /* Clear flag ADC channel configuration ready */
   LL_ADC_ClearFlag_CCRDY(ADC);
  LL_ADC_SetChannelSamplingTime(ADC, LL_ADC_CHANNEL_11, LL_ADC_SAMPLINGTIME_COMMON_1);
...
void ADC_Read(uint16_t *usData)	
{
  ...
  usData[0] = LL_ADC_REG_ReadConversionData12(ADC);
  while(LL_ADC_IsActiveFlag_EOC(ADC) == 0);
  usData[1] = LL_ADC_REG_ReadConversionData12(ADC);
  while(LL_ADC_IsActiveFlag_EOC(ADC) == 0);
  usData[2] = LL_ADC_REG_ReadConversionData12(ADC);
}
/* USER CODE END 1 */
