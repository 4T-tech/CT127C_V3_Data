...
void KEY_Proc(void)
{
    ...
    if(key_val == ASW_None)
    {
        ...
        if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_3) == GPIO_PIN_RESET) key_val = EX01_B1;
        else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_15) == GPIO_PIN_RESET) key_val = EX01_B2;
        else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_RESET) key_val = EX01_B3;
        else key_val = ASW_None;
    }
    if(key_val == ASW_None)
    {
        ...
        if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_3) == GPIO_PIN_RESET) key_val = EX01_B4;
        else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_15) == GPIO_PIN_RESET) key_val = EX01_B5;
        else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_RESET) key_val = EX01_B6;
        else key_val = ASW_None;
    }
#endif
