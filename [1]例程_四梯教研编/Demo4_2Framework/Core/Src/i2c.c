...
/* USER CODE BEGIN 1 */
/**
 * @brief API to write data to OLED
 *
 * @param ucType: data type, 0x40 or 0x00
 * @param ucData: data
 * @return None
*/
 ...
 * @param data: point to read data
 * @return None
*/
void E2P_ReadByte(uint8_t address, uint8_t *data)
{
    HAL_I2C_Mem_Read(&hi2c1, E2P_ADDRESS, address, \
...
{
    HAL_I2C_Mem_Write(&hi2c1, E2P_ADDRESS, address, \
                      I2C_MEMADD_SIZE_8BIT, &data, 1, 100);
}
/* USER CODE END 1 */
